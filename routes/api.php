...
// Получение ячеек за период + расчёт суммарного дилея
Route::get('/projects/{project}/batches/{batch}/images/{image}/delay', [ColoredCellsController::class, 'delayByImageAndPeriod']);
